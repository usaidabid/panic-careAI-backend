...
origins = [
    ...
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "https://3c6b1b768bdb.ngrok-free.app" ,
]

app.add_middleware(
    CORSMiddleware,
    allow_origins=origins,   # ab specific origins list use ho rahi hai
    allow_credentials=True,  # login/register ke liye zaroori hai
    allow_methods=["*"],
    allow_headers=["*"],
)
...
async def transcribe_and_speak(
    ...
    Location handling for emergency alerts is now separate via /initiate-emergency-call.
    Text queries should be sent to the dedicated /query endpoint.
    """
